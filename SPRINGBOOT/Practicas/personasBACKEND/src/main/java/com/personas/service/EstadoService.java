...
import com.personas.repository.EstadoRepository;
...
@Service //Notación para que los se declare la clase como de servicio
public class EstadoService implements EstadoRepository{

    //Se declara la interfaz EstadoRepository
    @Autowired //Esto permite crear una instancia sin crear un objeto
